...
export const en: typeof fi = {
	...
	updateAvailableDescription:
		"You are using an outdated version of Kalkki. Please update the app by pressing the button below.",
	...
	copyrightKalkki:
		"Kalkki is open source and you have the right to use, modify and distribute it as per the license below:",
