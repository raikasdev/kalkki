export const fi = {
	...
	updateAvailableDescription:
		"Käytössäsi on Kalkin vanha versio. Ole hyvä ja päivitä sovellus painamalla alla olevaa nappia.",
	updateAvailableButton: "Päivitä",

	/** Misc / ARIA */
	ariaMathInput: "Syötä matemaattinen lauseke",
	feedbackLink:
		"https://docs.google.com/forms/d/e/1FAIpQLScg-0pnRUbe2-c6gNEF6rH3r1HhwunjaJLwjaJ7927zWa8_3w/viewform",
	...
	copyrightKalkki:
		"Kalkki on avointa lähdekoodia ja sinulla on oikeus käyttää, muokata ja jakaa sitä alla olevien lisenssiehtojen mukaisesti.",
	copyrightKalkkiUses:
		"Kalkki hyödyntää seuraavia avoimen lähdekoodin kirjastoja ja työkaluja:",
