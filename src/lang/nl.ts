...
export const nl: typeof fi = {
  /** Welcome message */
  welcome: 'Welkom! Kalkki is <a href="https://github.com/raikasdev/kalkki">open source</a>.',
  welcomeStart: 'Begin met het schrijven van een uitdrukking in het veld hieronder.',
  welcomePwaPrompt: '<span id="pwa-install-prompt" hidden>Voor de beste ervaring op desktop <a href="#" onclick="installPWA()">installeert u kalkki als een PWA-toepassing</a>.',
  /** Options */
  options: 'Opties',
  ...
  updateAvailableDescription: 'U gebruikt een verouderde versie van Kalkki. Update de app bij door op de onderstaande knop te drukken.',
  ...
  /** About page */
  aboutVersion: 'Versie',
  aboutFromStudents: 'Rekenmachine-app gemaakt door studenten voor studenten. Kalkki is gemaakt door Roni Äikäs toen hij op de middelbare school zat.',
  aboutThanks: 'Speciale dank',
  aboutThanksTsry: 'Testausserveri ry en andere software testers',
  aboutThanksYTL: 'Toelatingsexamenraad van Finland voor het ontwikkelen van de wiskunde-engine in Abicus',
  aboutLicense: 'Licentie',
  aboutLicenseMit: 'Dit programma is open source en gelicentieerd onder de MIT-licentie en wordt geleverd zonder enige garantie.',

  /** Copyright page */
  copyrightOSS: 'Open source licenties',
  copyrightKalkki: 'Kalkki is open source en u hebt het recht om het te gebruiken, aan te passen en te verspreiden volgens de onderstaande licentie:',
  ...
  copyrightFullLicense: 'Je kunt de volledige licenties van de vermelde pakketten vinden <a href="/third-party-licenses.txt">hier</a>.',
