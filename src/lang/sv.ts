...
export const sv: typeof fi = {
  ...
  welcomePwaPrompt: '<span id="pwa-install-prompt" hidden>För bästa upplevelse på datorn, <a href="#" onclick="installPWA()">installera Kalkki som en PWA-applikation</a>.',
  /** Options */
